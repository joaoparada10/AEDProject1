...
public:
    ...
    std::unordered_map<std::string, Class> getEmpty_classes_map(const std::string& filename);
    std::unordered_map<std::string, Class> getClasses_map(const std::string& filename);
};
